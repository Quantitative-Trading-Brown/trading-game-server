...
def flush(game_id: str) -> None:
    # Should flush tick-based updates to the player
    orderbook_flush(game_id)
    accounting_flush(game_id)


def orderbook_flush(game_id: str) -> None:
...
def accounting_flush(game_id: str) -> None:
    ...
    for player_id in active_players:
        ...
        position_value = extract(r.get(f"player:{player_id}:inventory:position_value"))
